=== Excel Like Product Attribute And Tag Manager for WooCommerce and WP E-commerce - Light ===
Contributors: holest
...
Tags: excel, csv, import, export, woo, woocommerce, wpsc, ecommerce, e-commerce, wp-e-commerce, spreadsheet, product, import products, export products, editor, fast, easy
...
Excel-Like Attribute/Tag Managerr for WooCommerce and WP E-commerce - Light

== Description ==

Excel like product attribute and tag manager for WooCommerce / WP E-commerce 
This free light version of free trimmed version of famous 'Excel-like Product manager' ( http://holest.com/index.php/holest-outsourcing/joomla-wordpress/excel-like-manager-for-woocommerce-and-wp-e-commerce.html ) allowes: Fast management (edit) of attributes in wooCommerce and tags both in woocommerce and wp e-commerce; View of other product fields;
...
EDITABLE / IMPORTANBLE FIELDS: WooCommerce: Attributes, Tags; WP E-commerce: Tags
...
Tech forum: http://www.holest.com/index.php/forum/index.html
Direct support: support@holest.com

== Installation ==

1. Go to wp-admin > Plugins > Add New
2. Either use search on 'excel-like-product-attribute-and-tag-manager-for-woocommerce-and-wp-e-commerce-light' or go to 'Upload' if you already have zip package with you to install plug-in
