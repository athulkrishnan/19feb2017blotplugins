			...
			while (($data = fgetcsv($handle, 32768, $impexp_settings->delimiter)) !== FALSE) {
				if($n == 0 && $custom_import && $skip_first){
				   ...
				   if($tags_names_index > -1){
					  wp_set_object_terms( $id , array_map('trim',explode(",",$data[$tags_names_index])) , 'product_tag' );
				   }
...
-->
<!--
<link rel="stylesheet" href="<?php echo $excellikeproductatttag_baseurl.'core/jquery.removeRow.css'; ?>">
<script src="<?php echo $excellikeproductatttag_baseurl.'core/jquery.removeRow.js'; ?>" type="text/javascript"></script>
-->
...
<ul class="menu">
  ...
  <li>
   <a class="cmdBackToJoomla" href="<?php echo "admin.php?page=excellikeproductatttag-wpsc"; ?>" > <?php echo __("Back to Wordpress",'excellikeproductatttag'); ?> </a>
  </li>
  <?php } ?>
  ...
  <li>
   ...
   <ul>
	 ...
	 <li><span><button onclick="showSettings();return false;" ><?php echo __("Custom import settings",'excellikeproductatttag'); ?></button></span></li>
   </ul>
  </li>
  <li>
   ...
   <ul>
	 ...
	 <li><span><a target="_blank" href="<?php echo "http://www.holest.com/excel-like-product-manager-wpecommerce-documentation"; ?>" > <?php echo __("Help",'excellikeproductatttag'); ?> </a></span></li>
   </ul>
  </li>
  ...
  <li style="float:right;" >
   <table>
     <tr><td rowspan="2" ><?php echo __("Input units",'excellikeproductatttag');?>:&nbsp;&nbsp;</td><td><?php echo __("Weight",'excellikeproductatttag');?></td><td><?php echo __("Height",'excellikeproductatttag');?></td><td><?php echo __("Width",'excellikeproductatttag');?></td><td><?php echo __("Length",'excellikeproductatttag');?></td></tr> 
	 <tr>
...
<div class="footer">
 <div class="pagination">
   ...
   ?>
   <span class="pageination_info"><?php echo sprintf(__("Page %s of %s, total %s products by filter criteria",'excellikeproductatttag'),$page_no,ceil($count / $limit),$count); ?></span>
...
window.onbeforeunload = function() {
	...
	if(n > 0){
	  doSave();
	  return "<?php echo __("Transactions ongoing. Plese wait a bit more for them to complete!",'excellikeproductatttag');?>";
	}else
	  return;	   
}
...
jQuery(document).ready(function(){
	...
	jQuery('#dg_wpsc').handsontable({
	  ...
	  ,colHeaders:[
		...
		<?php if(fn_show_filed('name')) echo  ',"'.__("Product Name",'excellikeproductatttag').'"';?>
		...
		<?php if(fn_show_filed('taxable')) echo  ',"'. __("Taxable",'excellikeproductatttag').'"';?>
		<?php if(fn_show_filed('loc_shipping')) echo  ',"'. __("Local ship.",'excellikeproductatttag').'"';?>
		<?php if(fn_show_filed('int_shipping')) echo  ',"'. __("Int. ship.",'excellikeproductatttag').'"';?>
		<?php
			foreach($custom_fileds as $cfname => $cfield){ 
