...
//			if(isset($this->largeattributes[$att->name]) && $this->largeattributes[$att->name] === "1")
			...
			$this->LoadAttributeTerms($att,$att->name,0);
...
//			$catname = str_replace("\n", '\n', str_replace('"', '\"', addcslashes(str_replace("\r", '', (string)$catname), "\0..\37'\\")));
...
//				}
			...
			echo 'W3Ex._translate_strings["trans_linkallvars"] = "'.str_replace('"','\"',$arrTranslated['trans_linkallvars']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_skipduplicates"] = "'.str_replace('"','\"',$arrTranslated['trans_skipduplicates']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_column_settings"] = "'.str_replace('"','\"',$arrTranslated['trans_column_settings']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_selected_text"] = "'.str_replace('"','\"',$arrTranslated['trans_selected_text']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_saving_batch"] = "'.str_replace('"','\"',$arrTranslated['trans_saving_batch']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_table_views"] = "'.str_replace('"','\"',$arrTranslated['trans_table_views']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_custom_fields"] = "'.str_replace('"','\"',$arrTranslated['trans_custom_fields']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_find_custom_fields"] = "'.str_replace('"','\"',$arrTranslated['trans_find_custom_fields']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_plugin_settings"] = "'.str_replace('"','\"',$arrTranslated['trans_plugin_settings']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_collapse_filters"] = "'.str_replace('"','\"',$arrTranslated['trans_collapse_filters']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_expand_filters"] = "'.str_replace('"','\"',$arrTranslated['trans_expand_filters']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_images_hover"] = "'.str_replace('"','\"',$arrTranslated['trans_images_hover']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_straight_edit"] = "'.str_replace('"','\"',$arrTranslated['trans_straight_edit']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_data_placeholder"] = "'.str_replace('"','\"',$arrTranslated['trans_data_placeholder']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_sell_status"] = "'.str_replace('"','\"',$arrTranslated['trans_sell_status']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_show_sell"] = "'.str_replace('"','\"',$arrTranslated['trans_show_sell']).'";'; echo PHP_EOL;
			echo 'W3Ex._translate_strings["trans_show_all"] = "'.str_replace('"','\"',$arrTranslated['trans_show_all']).'";'; echo PHP_EOL;
			echo 'W3Ex.post_excerpt = "'. str_replace('"','\"',$arrTranslated['post_excerpt']).'";'; echo PHP_EOL;
			echo 'W3Ex.post_content = "'.str_replace('"','\"',$arrTranslated['post_content']).'";'; echo PHP_EOL;
			echo 'W3Ex._thumbnail_id = "'.str_replace('"','\"',$arrTranslated['_thumbnail_id']).'";'; echo PHP_EOL;
			echo 'W3Ex._product_image_gallery = "'.str_replace('"','\"',$arrTranslated['_product_image_gallery']).'";'; echo PHP_EOL;
			echo 'W3Ex._sku = "'.str_replace('"','\"',$arrTranslated['_sku']).'";'; echo PHP_EOL;
			echo 'W3Ex.post_name = "'.str_replace('"','\"',$arrTranslated['post_name']).'";'; echo PHP_EOL;
			echo 'W3Ex.product_tag = "'.str_replace('"','\"',$arrTranslated['product_tag']).'";'; echo PHP_EOL;
			echo 'W3Ex._virtual = "'.str_replace('"','\"',$arrTranslated['_virtual']).'";'; echo PHP_EOL;
			echo 'W3Ex._downloadable = "'.str_replace('"','\"',$arrTranslated['_downloadable']).'";'; echo PHP_EOL;
			...
			echo 'W3Ex.post_title = "'.str_replace('"','\"',$arrTranslated['post_title']).'";'; echo PHP_EOL;
			echo 'W3Ex.product_cat = "'.str_replace('"','\"',$arrTranslated['product_cat']).'";'; echo PHP_EOL;
			echo 'W3Ex._regular_price = "'.str_replace('"','\"',$arrTranslated['_regular_price']).'";'; echo PHP_EOL;
			echo 'W3Ex._sale_price = "'.str_replace('"','\"',$arrTranslated['_sale_price']).'";'; echo PHP_EOL;
			echo 'W3Ex._sale_price_dates_from = "'.str_replace('"','\"',$arrTranslated['_sale_price_dates_from']).'";'; echo PHP_EOL;
			echo 'W3Ex._sale_price_dates_to = "'.str_replace('"','\"',$arrTranslated['_sale_price_dates_to']).'";'; echo PHP_EOL;
			echo 'W3Ex._featured = "'.str_replace('"','\"',$arrTranslated['_featured']).'";'; echo PHP_EOL;
			echo 'W3Ex._tax_status = "'.str_replace('"','\"',$arrTranslated['_tax_status']).'";'; echo PHP_EOL;
			echo 'W3Ex._tax_class = "'.str_replace('"','\"',$arrTranslated['_tax_class']).'";'; echo PHP_EOL;
			echo 'W3Ex._weight = "'.str_replace('"','\"',$arrTranslated['_weight']).'";'; echo PHP_EOL;
			echo 'W3Ex._height = "'.str_replace('"','\"',$arrTranslated['_height']).'";'; echo PHP_EOL;
			echo 'W3Ex._width = "'.str_replace('"','\"',$arrTranslated['_width']).'";'; echo PHP_EOL;
			echo 'W3Ex._length = "'.str_replace('"','\"',$arrTranslated['_length']).'";'; echo PHP_EOL;
			echo 'W3Ex._stock = "'.str_replace('"','\"',$arrTranslated['_stock']).'";'; echo PHP_EOL;
			echo 'W3Ex._stock_status  = "'.str_replace('"','\"',$arrTranslated['_stock_status']).'";'; echo PHP_EOL;
			echo 'W3Ex._manage_stock = "'.str_replace('"','\"',$arrTranslated['_manage_stock']).'";'; echo PHP_EOL;
			echo 'W3Ex._backorders = "'.str_replace('"','\"',$arrTranslated['_backorders']).'";'; echo PHP_EOL;
			echo 'W3Ex._sold_individually = "'.str_replace('"','\"',$arrTranslated['_sold_individually']).'";'; echo PHP_EOL;
			echo 'W3Ex.product_shipping_class = "'.str_replace('"','\"',$arrTranslated['product_shipping_class']).'";'; echo PHP_EOL;
			echo 'W3Ex._purchase_note = "'.str_replace('"','\"',$arrTranslated['_purchase_note']).'";'; echo PHP_EOL;
			echo 'W3Ex.post_status = "'.str_replace('"','\"',$arrTranslated['post_status']).'";'; echo PHP_EOL;
			echo 'W3Ex._visibility = "'.str_replace('"','\"',$arrTranslated['_visibility']).'";'; echo PHP_EOL;
			echo 'W3Ex._upsell_ids = "'.str_replace('"','\"',$arrTranslated['_upsell_ids']).'";'; echo PHP_EOL;
			echo 'W3Ex._crosssell_ids = "'.str_replace('"','\"',$arrTranslated['_crosssell_ids']).'";'; echo PHP_EOL;
			echo 'W3Ex._downloadable = "'.str_replace('"','\"',$arrTranslated['_downloadable']).'";'; echo PHP_EOL;
			echo 'W3Ex._virtual = "'.str_replace('"','\"',$arrTranslated['_virtual']).'";'; echo PHP_EOL;
			echo 'W3Ex._download_expiry = "'.str_replace('"','\"',$arrTranslated['_download_expiry']).'";'; echo PHP_EOL;
			echo 'W3Ex._download_limit = "'.str_replace('"','\"',$arrTranslated['_download_limit']).'";'; echo PHP_EOL;
			echo 'W3Ex._downloadable_files = "'.str_replace('"','\"',$arrTranslated['_downloadable_files']).'";'; echo PHP_EOL;
			echo 'W3Ex._download_type = "'.str_replace('"','\"',$arrTranslated['_download_type']).'";'; echo PHP_EOL;
			echo 'W3Ex._product_url = "'.str_replace('"','\"',$arrTranslated['_product_url']).'";'; echo PHP_EOL;
			echo 'W3Ex._button_text = "'.str_replace('"','\"',$arrTranslated['_button_text']).'";'; echo PHP_EOL;
			echo 'W3Ex.comment_status = "'.str_replace('"','\"',$arrTranslated['comment_status']).'";'; echo PHP_EOL;
			echo 'W3Ex.menu_order = "'.str_replace('"','\"',$arrTranslated['menu_order']).'";'; echo PHP_EOL;
			echo 'W3Ex.product_type = "'.str_replace('"','\"',$arrTranslated['product_type']).'";'; echo PHP_EOL;
			echo 'W3Ex._default_attributes = "'.str_replace('"','\"',$arrTranslated['_default_attributes']).'";'; echo PHP_EOL;
			echo 'W3Ex.grouped_items = "'.str_replace('"','\"',$arrTranslated['grouped_items']).'";'; echo PHP_EOL;
			echo 'W3Ex.post_date = "'.str_replace('"','\"',$arrTranslated['post_date']).'";'; echo PHP_EOL;
			echo 'W3Ex._custom_attributes = "'.str_replace('"','\"',$arrTranslated['_custom_attributes']).'";'; echo PHP_EOL;
			echo 'W3Ex._variation_description = "'.str_replace('"','\"',$arrTranslated['_variation_description']).'";'; echo PHP_EOL;
		echo "</script>";
		?>
			...
			<?php
				...
				if(count($this->attributes) > 0)
				{
					foreach($this->attributes as $attr)
					{
						...
						echo $attr->label.': </td><td><select class="makechosen custattributes" data-placeholder="'.$arrTranslated['trans_data_placeholder'].'" multiple style="width:250px;"> <option value=""></option>';
...
//								$woo_tags = get_terms( 'product_tag', $args );
			...
			>
				...
				<td><?php echo $arrTranslated['_stock_status']; ?>: </td>
				<td>
				<select id="stockstatusparams">
				<option value="skip"><?php _e( 'Skip', 'woocommerce-advbulkedit');?></option>
				<option value="instock"><?php echo $arrTranslated['trans_instock']; ?></option>
				<option value="outofstock"><?php echo $arrTranslated['trans_outofstock'];?></option>
			</select>
				...
				<div id="pluginsettingstab-2">
					...
					<tr>
						...
						<td width="55%" style="padding-top: 20px;">
							...
							echo $echotext;	 ?>
							><?php _e( 'Stock Qty/Stock Status', 'woocommerce-advbulkedit'); ?></label>
						</td>
					</tr>
					</table>
					</div>
...
//							'<option value="remove">'.__('remove','woocommerce-advbulkedit').'</option></select></td><td class="nontextnumbertd">'
