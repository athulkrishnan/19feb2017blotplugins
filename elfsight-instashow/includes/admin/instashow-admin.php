...
function elfsight_instashow_admin_init() {
    ...
    wp_register_script('elfsight-instashow', plugins_url('assets/instashow/dist/jquery.instashow.packaged.js', ELFSIGHT_INSTASHOW_FILE), array('jquery'), ELFSIGHT_INSTASHOW_VERSION);
    wp_register_script('elfsight-instashow-admin', plugins_url('assets/instashow-admin.js', ELFSIGHT_INSTASHOW_FILE), array('jquery', 'elfsight-instashow'), ELFSIGHT_INSTASHOW_VERSION);
}
...
function elfsight_instashow_update_preferences() {
    ...
    if (array_intersect(array_keys($config_available_options), array_keys($_REQUEST))) {
        ...
        if (!file_exists($preferences_api_config_path) || !is_writable($preferences_api_config_path)) {
            ...
            $config = json_decode(file_get_contents($preferences_api_config_path), true) ?: array();
